...
class PoseDecoder(nn.Module):
    def __init__(self, num_ch_enc, num_input_features, num_frames_to_predict_for=None, stride=1):
        ...
        self.convs["pose0"] = nn.Conv2d(num_input_features * 256, 256, 3, stride, 1)
        self.convs["pose1"] = nn.Conv2d(256, 256, 3, stride, 1)
        self.convs["pose2"] = nn.Conv2d(256, 6 * num_frames_to_predict_for, 1)
        self.relu = nn.ReLU()
